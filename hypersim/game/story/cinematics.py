...
FIRST_POINT_INTERACTION_DIALOGUES = {
    "greeting": [
        {"speaker": "The First Point", "text": "Back already? Good. Curiosity beats panic."},
        {"speaker": "The First Point", "text": "What do you want right now?",
         "choices": [
             ("Give me a quick trial.", "line_trial"),
             ("How does combat work?", "combat_tutorial"),
    ...
    "line_trial": [
        {"speaker": "The First Point", "text": "Then prove rhythm under pressure."},
        {"speaker": "The First Point", "text": "Reach Midpoint Station. Return to the Origin."},
        {"speaker": "The First Point", "text": "No speeches. Just motion and intent."},
        {"speaker": "The First Point", "text": "Take the trial?",
         "choices": [
             ("Start the trial.", "start_line_trial"),
             ("Not yet.", "greeting"),
         ]},
    ],
    "combat_tutorial": [
        {"speaker": "The First Point", "text": "Confrontation gives you three doors."},
        {"speaker": "The First Point", "text": "FIGHT ends danger fast, but hardens the world around you."},
        {"speaker": "The First Point", "text": "ACT can defuse fear before it becomes violence."},
        {"speaker": "The First Point", "text": "MERCY works once a rival's will to fight collapses."},
        {"speaker": "The First Point", "text": "Use SHIFT to slip out of direct impact for a heartbeat."},
        {"speaker": "The First Point", "text": "What next?",
         "choices": [
             ("Give me a quick trial.", "line_trial"),
             ("Tell me about the Line.", "line_info"),
             ("Who are you, really?", "identity"),
    ...
    "line_info": [
        {"speaker": "The First Point", "text": "The Line is not empty. It is opinion made geometry."},
        {"speaker": "The First Point", "text": "Forward Sentinels worship progress. Void Echoes interrogate memory."},
        {"speaker": "The First Point", "text": "Midpoint Station survives by refusing both extremes."},
        {"speaker": "The First Point", "text": "Past the Endpoint, width waits for those who can bear it."},
        {"speaker": "The First Point", "text": "What next?",
         "choices": [
    ...
    "identity": [
        {"speaker": "The First Point", "text": "I am a paradox that stabilized."},
        {"speaker": "The First Point", "text": "The first awareness that refused to dissolve back into the Void."},
        {"speaker": "The First Point", "text": "Every dimension is an argument I made against nothingness."},
        {"speaker": "The First Point", "text": "You are my newest argument."},
        {"speaker": "The First Point", "text": "What next?",
         "choices": [
             ("Tell me about the Line.", "line_info"),
             ("How do I defend myself?", "combat_tutorial"),
    ...
    "farewell": [
        {"speaker": "The First Point", "text": "Go, then."},
        {"speaker": "The First Point", "text": "Do not chase certainty. Chase better questions."},
        {"speaker": "The First Point", "text": "Return when the Line stops being enough."},
    ],
}
