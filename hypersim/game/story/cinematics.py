...
FIRST_POINT_INTERACTION_DIALOGUES = {
    ...
    "combat_tutorial": [
        {"speaker": "The First Point", "text": "You sense the conflict that awaits you."},
        {"speaker": "The First Point", "text": "Not all beings on this Line will welcome you."},
        {"speaker": "The First Point", "text": "When you encounter one who challenges you, you will enter a state of confrontation."},
        {"speaker": "The First Point", "text": "In that moment, you have choices. Let me explain each one."},
        {"speaker": "", "text": "The First Point's glow brightens as it imparts ancient wisdom."},
        {"speaker": "The First Point", "text": "You may strike at your opponent using FIGHT. Time your attack well for greater effect."},
        {"speaker": "The First Point", "text": "Although, keep in mind that violence leaves marks on both sides."},
        {"speaker": "The First Point", "text": "You may interact with your opponent using ACT."},
        {"speaker": "The First Point", "text": "Speak to them. Observe them. Sometimes understanding is mightier than force."},
        {"speaker": "The First Point", "text": "If you carry healing items or tools, you may use them to aid yourself with ITEM"},
        {"speaker": "The First Point", "text": "When an opponent's will to fight fades, you may show MERCY."},
        {"speaker": "The First Point", "text": "Spare them, and they may become something other than an enemy."},
        {"speaker": "The First Point", "text": "You may also attempt to flee if the battle is not worth fighting."},
        {"speaker": "", "text": "The First Point pulses with a deeper, more profound light."},
        {"speaker": "The First Point", "text": "And finally... SHIFT."},
        {"speaker": "The First Point", "text": "This is the gift of dimensional perception."},
        {"speaker": "The First Point", "text": "You can shift your awareness between different dimensional states."},
        {"speaker": "The First Point", "text": "As a POINT, you become invulnerable but cannot move."},
        {"speaker": "The First Point", "text": "As a LINE, you move only horizontally, blocking vertical threats."},
        {"speaker": "The First Point", "text": "As a PLANE, you move freely in two directions."},
        {"speaker": "The First Point", "text": "In time, as you grow, more states will reveal themselves to you."},
        {"speaker": "The First Point", "text": "Master these shifts, and no attack shall touch you."},
